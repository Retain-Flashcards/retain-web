...
<div class='content'>
    ...
    <el-main class='main-content' v-loading='submittingNote'>
        ...
        <div id='frontEditor'>
            <div contenteditable>This is a <cloze-indicator :n=1 @click='closeCloze' hint="test">cloze</cloze-indicator> card.</div>
...
import ClozeIndicator from '../components/basic/ClozeIndicator.vue'
import CardEditor from '../components/basic/CardEditor.vue'
